		...
		function start_pirobox() {
			...
			piro_single.each(function(d) {
				...
				item.bind('click',function(d) {
					...
					var this_url = item.attr('href');
						var descr = '<a href="http://' + item.attr('title') + '" target="_blank" title="Visit the site" class="folio-link">' + item.attr('title') + '</a>' ;		
						if( descr == ""){
						caption.html('<p>'+ this_url+'<a href="http://'+ item.attr('title') +'" class="link_to" target="_blank" title="Visit the site"></a></p>');
						}else{
						caption.html('<p>'+ descr+'<a href="http://'+ item.attr('title') +'" class="link_to" target="_blank" title="Visit the site"></a></p>');
						}
					$('.c_c').addClass('unique');
			...
			$(piro_gallery).each(function(array) {
					...
					item.bind('click',function(c) {
						...
						if( descr == ""){
						caption.html('<p>'+ this_url+'<em class="number">' + number + '</em><a href="http://'+ item.attr('title') +'" class="link_to" target="_blank" title="Visit the site"></a></p>');
						}else{
						caption.html('<p>'+ descr+'<em class="number">' + number + '</em><a href="http://'+ item.attr('title') +'" class="link_to" target="_blank" title="Visit the site"></a></p>');
						}
						if(item.is('.last')){
